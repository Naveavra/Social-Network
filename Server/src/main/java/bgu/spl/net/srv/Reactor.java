...
public class Reactor<T> implements Server<T> {
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        synchronized (conID) {
            int id = conID.get();
            //System.out.println("adding id = " + conID.get());
            connections.getUserCH().put(conID.getAndIncrement(), (ConnectionHandler<String>) handler);
            handler.getProtocol().start(id, ConnectionsImpl.getInstance());
        }
